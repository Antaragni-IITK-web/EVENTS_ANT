		...
		<ProtectedRoute>
			<Section className="min-h-screen flex flex-col items-center justify-center gap-8 pt-24 pb-12">
				<div className="text-center">
					...
					<h1 className="font-title text-gradient mx-auto w-fit text-5xl font-black md:!text-7xl">
						Claim Your ID
					</h1>
					<p className="mt-4 text-lg text-foreground/60">
						A few details and your Antaragni &rsquo;26 pass is ready.
					</p>
				</div>

				<div className="glass w-full max-w-6xl rounded-3xl p-6 md:!p-10">
					<form
