...
const BLOBS = [
	{ x: "12%", y: "8%", size: 560, from: "rgba(217,38,67,0.2)", depth: 0.5, dur: 34 },
	{ x: "70%", y: "16%", size: 480, from: "rgba(255,138,61,0.16)", depth: 0.9, dur: 42 },
	{ x: "48%", y: "68%", size: 660, from: "rgba(74,32,44,0.5)", depth: 0.3, dur: 38 },
	{ x: "86%", y: "70%", size: 440, from: "rgba(255,209,102,0.1)", depth: 1.1, dur: 30 },
	{ x: "4%", y: "62%", size: 400, from: "rgba(140,35,51,0.22)", depth: 0.7, dur: 46 },
	{ x: "60%", y: "94%", size: 520, from: "rgba(255,107,53,0.1)", depth: 0.6, dur: 40 },
];
	...
	return (
		<div ref={wrapRef} className="absolute inset-0 overflow-hidden" aria-hidden>
			...
			<div
				...
				style={{
					background:
						"linear-gradient(180deg, rgba(255,138,61,0.13), transparent 70%)",
			...
			<div
				...
				style={{
					background:
						"linear-gradient(180deg, rgba(217,38,67,0.1), transparent 72%)",
