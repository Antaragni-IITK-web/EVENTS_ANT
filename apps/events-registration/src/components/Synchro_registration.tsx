...
type FormShape = {
  ...
  "Member Name 2": string;
  "Member Name 3": string;
  "Member Name 4": string;
  "Member Name 5": string;
  "Member Name 6": string;
...
export default function Synchro_Registration() {
